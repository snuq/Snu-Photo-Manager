...
movietypes = ['.avi', '.mov', '.mp4', '.mpeg4', '.mts', '.mpg', '.mpeg', '.vob', '.mkv', '.ogv', '.m2v', '.webm']
audiotypes = ['.wav', '.mp3', '.aif', '.aiff', '.ogg', '.aac', '.wma', '.flac']
...
containers = ['mp4', 'matroska', 'mov', 'webm', 'ogg', 'avi', 'mpeg']
containers_friendly = ['MP4', 'Matroska', 'Quicktime', 'WebM', 'Ogg', 'AVI', 'MPEG']
containers_extensions = ['mp4', 'mkv', 'mov', 'webm', 'ogv', 'avi', 'mpg']
video_codecs = ['libx264', 'libx265', 'mpeg4', 'libvpx-vp9', 'libvpx', 'mpeg2video', 'libtheora', 'mjpeg']
video_codecs_friendly = ['H.264', 'HEVC/H.265', 'MPEG 4', 'VP9', 'VP8', 'MPEG 2', 'Ogg Theora', 'MPEG']
video_codecs_bitrate_divisor = [250, 450, 150, 400, 200, 80, 150, 60]
audio_codecs = ['aac', 'ac3', 'libmp3lame', 'flac', 'libopus', 'libvorbis', 'pcm_s16le', 'mp2', '']
audio_codecs_bitrate = [160, 160, 192, 0, 160, 192, 0, 192, 0]
audio_codecs_friendly = ['AAC', 'AC-3', 'MP3', 'FLAC', 'Opus', 'Ogg Vorbis', 'PCM/Wav', 'MP2', 'None/Remove']
